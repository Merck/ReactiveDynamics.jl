...
|---|---|---|---|
| `name` | Symbol (closed identity) | `placeName` (`ReactiveDynamics.jl:44`) | Unique key; the FK target for `ArcSpec.species` (§6.5). |
