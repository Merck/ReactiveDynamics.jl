...
PopulationEntry(place, kind; count = 1, attributes = Dict{Symbol, Any}()) =
    PopulationEntry(place, kind, count, Dict{Symbol, Any}(attributes))
...
# What place (place) is an agent currently assigned to.
get_place(a::AbstractStructuredToken) = a.place
set_place!(a::AbstractStructuredToken, place::Symbol) = a.place = place
